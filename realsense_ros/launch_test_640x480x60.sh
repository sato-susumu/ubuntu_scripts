...
launch_command "ros2 launch realsense2_camera rs_launch.py depth_qos:=SENSOR_DATA color_qos:=SENSOR_DATA enable_sync:=true align_depth.enable:=true enable_color:=true enable_depth:=true depth_module.profile:=640x480x60 rgb_camera.profile:=640x480x60" "realsense2_camera"
