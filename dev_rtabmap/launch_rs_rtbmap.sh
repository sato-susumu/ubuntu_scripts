...
launch_command 'ros2 launch realsense2_camera rs_launch.py enable_gyro:=true enable_accel:=true unite_imu_method:=1 enable_sync:=true depth_module.profile:="640,480,30" rgb_camera.profile:="640,480,30"' "realsense"
